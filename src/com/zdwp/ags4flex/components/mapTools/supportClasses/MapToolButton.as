package com.zdwp.ags4flex.components.mapTools.supportClasses 
{ 
	...
	import com.zdwp.ags4flex.skins.SingleButtonSkin;
	...
	{ 
		...
		public function MapToolButton()
		{
			...
			this.setStyle("skinClass", com.zdwp.ags4flex.skins.SingleButtonSkin);
